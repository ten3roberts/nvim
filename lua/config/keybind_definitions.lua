...
local keybinds = {
  ...
  ["trouble-lsp"] = { keybind = "<leader>xl", desc = "LSP References / Definitions (Trouble)" },
  ["trouble-symbols"] = { keybind = "<leader>xs", desc = "Symbols (Trouble)" },
  ["trouble-quickfix"] = { keybind = "<leader>xq", desc = "Quickfix List (Trouble)" },
